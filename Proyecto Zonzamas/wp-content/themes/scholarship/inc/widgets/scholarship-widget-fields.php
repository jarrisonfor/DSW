    ...
    switch ( $scholarship_widgets_field_type ) {
        ...
        ?>
                <div class="mt-single-checkbox">
                    <p>
                        <input id="<?php echo esc_attr( $instance->get_field_id( $field_option_name ) ); ?>" name="<?php echo esc_attr( $instance->get_field_name( $scholarship_widgets_name ).'['.$field_option_name.']' ); ?>" type="checkbox" value="1" <?php checked( '1', $current_category ); ?>/>
