        ...
        <div class="footer-widgets-area clearfix">
            <div class="mt-footer-widget-wrapper mt-column-wrapper clearfix">
          		<div class="scholarship-footer-widget wow fadeInLeft" data-wow-duration="0.5s">
          			<?php
                        if ( is_active_sidebar( 'scholarship_footer_sidebar' ) ) :
                            dynamic_sidebar( 'scholarship_footer_sidebar' );
              			endif;
          			?>
          		</div>
                ...
                <?php
                    if ( is_active_sidebar( 'scholarship_footer_sidebar-2' ) ) :
                        dynamic_sidebar( 'scholarship_footer_sidebar-2' );
                    endif;
          		?>
          		</div>
                <?php } ?>
                ...
                <?php
                    if ( is_active_sidebar( 'scholarship_footer_sidebar-3' ) ) :
                        dynamic_sidebar( 'scholarship_footer_sidebar-3' );
                    endif;
                ?>
                </div>
                <?php } ?>
                ...
                <?php
                    if ( is_active_sidebar( 'scholarship_footer_sidebar-4' ) ) :
                        dynamic_sidebar( 'scholarship_footer_sidebar-4' );
                    endif;
                ?>
                </div>
            <?php } ?>
