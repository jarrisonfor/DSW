...
@section('contenido')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Alta a un nuevo usuario</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="alias" class="col-md-4 col-form-label text-md-right">Alias (MA)</label>

                                <div class="col-md-6">
                                    <input id="alias" type="alias" class="form-control @error('alias') is-invalid @enderror"
                                        name="alias" value="{{ old('alias') }}" required autocomplete="off">
