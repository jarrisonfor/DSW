			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div style="text-align: center; padding: 10px;">
						<a href="{{ route('social.auth', 'google') }}"><img style="margin: 0 10px; width: 50px;" src="{{url('img')}}/google.png"></a>
						<a href="{{ route('social.auth', 'discord') }}"><img style="margin: 0 10px; width: 50px;" src="{{url('img')}}/discord.png"></a>
						<a href="{{ route('social.auth', 'github') }}"><img style="margin: 0 10px; width: 50px;" src="{{url('img')}}/github.png"></a>
					</div>
